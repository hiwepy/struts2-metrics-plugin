...
public class MetricsMetersInterceptor extends AbstractInterceptor {

	protected static final Logger LOG = LogManager.getLogger(MetricsMetersInterceptor.class);
