...
public class MetricsTimersInterceptor extends AbstractInterceptor {

	protected static final Logger LOG = LogManager.getLogger(MetricsTimersInterceptor.class);
