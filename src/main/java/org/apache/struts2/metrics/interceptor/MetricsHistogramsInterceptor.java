...
public class MetricsHistogramsInterceptor extends AbstractInterceptor {

	protected static final Logger LOG = LogManager.getLogger(MetricsHistogramsInterceptor.class);
