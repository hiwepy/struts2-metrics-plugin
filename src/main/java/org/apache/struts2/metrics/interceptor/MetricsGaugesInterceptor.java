...
public class MetricsGaugesInterceptor extends AbstractInterceptor {

	protected static final Logger LOG = LogManager.getLogger(MetricsGaugesInterceptor.class);
